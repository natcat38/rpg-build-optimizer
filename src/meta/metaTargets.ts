...
export const META_TARGETS: Record<string, MetaTarget> = {
  ...
  // Ideal (weight-1.0) picks from src/teams/comps.ts — without a recipe here the
  // plan solves them unconstrained and returns a rainbow stat-stick. Guarded by
  // the coverage test in src/teams/comps.test.ts.
  albedo: {
    characterKey: 'albedo',
    setRequirement: { kind: '4pc', setKey: 'HuskOfOpulentDreams' },
    mains: { sands: 'def_pct', goblet: 'elemental_dmg' },
  ...
  charlotte: {
    ...
    setRequirement: { kind: '4pc', setKey: 'SongOfDaysPast' },
    mains: { sands: 'hp_pct', goblet: 'hp_pct' },
    erTarget: 180,
    objective: 'hp_pct',
  ...
  gorou: {
    characterKey: 'gorou',
    setRequirement: { kind: '4pc', setKey: 'NoblesseOblige' },
    mains: { sands: 'er_pct', goblet: 'def_pct', circlet: 'def_pct' },
    erTarget: 200,
    objective: 'def_pct',
  ...
  kamisato_ayato: {
    ...
    setRequirement: { kind: '4pc', setKey: 'EchoesOfAnOffering' },
    mains: { sands: 'atk_pct', goblet: 'elemental_dmg' },
    erTarget: 130,
    objective: 'crit_value',
  ...
  nilou: {
    characterKey: 'nilou',
    setRequirement: { kind: '4pc', setKey: 'VourukashasGlow' },
    mains: { sands: 'hp_pct', goblet: 'hp_pct', circlet: 'hp_pct' },
    erTarget: 130,
    objective: 'hp_pct',
    source: 'https://keqingmains.com/nilou/',
    statTargets: { hp: 60000 },
  },
  ororon: {
    characterKey: 'ororon',
    setRequirement: { kind: '4pc', setKey: 'ScrollOfTheHeroOfCinderCity' },
