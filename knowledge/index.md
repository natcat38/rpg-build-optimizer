...
Architecture decisions — client-side-only, frozen dataset, optimiser choice,
share links, GOOD import, GameAdapter, AI explain proxy, character guides, and
their amendments — are recorded in [`docs/adr/`](../docs/adr/), numbered in
order.
